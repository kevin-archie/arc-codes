<h1 align="center">Hi, I'm Kevin Archie! 👋 </h1>
...
<div style="display: flex; justify-content: space-between; align-items: flex-start; margin-top: 20px;">
    ...
    <div style="flex: 1; max-width: 45%;">
        <img align="left" width="50%" alt="if you see this, it means my metrics are not working" src="https://github.com/kevin-archie/arc-codes/blob/main/github-metrics.svg">
    </div>
  ...
  <div style="flex: 1; max-width: 45%; text-align: left; margin-left: 20px;">
        ...
        <p>
            <a href="https://www.linkedin.com/in/kevin-archie/" target="_blank" style="text-decoration: none;">
